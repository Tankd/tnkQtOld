...
namespace QMail
{
  ...
  //  void closeDatabase();
    //   QSqlDatabase createDatabase();
       ...
       int maximumConcurrentServiceActions();
       int maximumConcurrentServiceActionsPerProcess();
       int maximumPushConnections();
      // int databaseAutoCloseTimeout();
