...
class    QMailBase64Codec : public QMailCodec
{
public:
...
class    QMailQuotedPrintableCodec : public QMailCodec
{
public:
    enum ContentType { Text, Binary };
...
class    QMailPassThroughCodec : public QMailCodec
{
    virtual QString name() const;
...
class    QMailLineEndingCodec : public QMailCodec
{
    virtual QString name() const;
